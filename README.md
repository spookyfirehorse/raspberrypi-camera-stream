...
# test rpi4 24 h test sync stable min cpu
     ...
     -c:v copy \
     -acodec libfdk_aac -eld_v2 1  -vbr 0   -fps_mode:v cfr -af aresample=async=1:first_pts=0   -map 0:0 -map 0:1  \
       -f rtsp -rtsp_transport udp rtsp://localhost:8554"/mystream
...
# last test rpi3 28 h
     ...
     -threads $(nproc)  -c:a libfdk_aac -profile:a aac_he -vbr 0 -map 0:0 -map 0:1  -af aresample=async=1:first_pts=0  -f rtsp -rtsp_transport udp rtsp://localhost:8554"/mystream
...
## alltime winner 10 % cpu very stable and long run for armhf bookworm cpu a52 rpi 3 z2w
        ...
        -t 0 --flush 0   -n --inline -o  - | ffmpeg  -hide_banner -copyts -fflags nobuffer+discardcorrupt+genpts  -flags low_delay  \
